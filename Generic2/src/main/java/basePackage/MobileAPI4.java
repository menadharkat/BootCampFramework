...
public class MobileAPI4 {
    ...
    public static AppiumDriver getDriver(String OS, String deviceName, String version) throws IOException {
        ...
        if (OS.equalsIgnoreCase("Android")) {
            ...
            capabilities.setCapability(MobileCapabilityType.APP, "/Users/djafarouldslimane/Documents/BootCampAutomation/Generic2/src/main/resources/WhatsApp Messenger_v2.19.159_apkpure.com.apk");
